/*
  ...
  - 12/16/25: V0.10 - Set minimum PWM to 0 to prevent backwards runaway PWM. Tested with prototype PCBs.
*/
...
#define MIN_EFFECTIVE_PWM 0            // The minimum PWM given to the slave motor during movement
...
void loop() {
  ...
  if (current_time_ms - lastPrintTime >= 500) {
    ...
    Serial.print("Slave DIR output: "); Serial.println(current_pwm >= 0 ? "LOW" : "HIGH");
