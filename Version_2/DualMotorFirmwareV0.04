/*
  ...
  Update Log:
  - 6/13/25: V0.01 - Adapted from old voltage emulator module. Monitors current and distributes load between two motors
*/
...
#define MASTER_SLAVE_SHARING 50         // PERCENT. Percentage of total load taken by master. 50 means 50% (equally shared). DO NOT SET TO 0.
...
#define Kp_current 0.5      // Proportional Gain
#define Ki_current 0.00     // Integral Gain
#define Kd_current 0.000    // Derivative Gain (start at 0, add if needed for stability)
